...
After the great war in the year 2100, in which both his parents fought, the AI robots won and started taking over the world. Zuni's parents knew that one day the AIs would come to take over their temple, so they started training Zuni to also become a samurai.

The day Zuni turned 13 they arrived. His mother hid Zuni in a garbage bin where he later watched his parents get executed by the AI robots. Then the robots burned the temple to the ground and Zuni kept on hiding for two days straight.
...
## Player
Zuni, a 23-year-old, mostly self-taught samurai.

### Weapon
He wields a katana that once belonged to his father. The katana has a sharpness stat. The sharper it is, the more damage it does. The more it gets used the less sharp it becomes. You can use different sharpening stones to increase the sharpness of the katana.

### Armour
He starts off with no armour, but with money he can buy some which increase his defence, reducing damage taken by a percentage.

### Healing
He will need to use bandages if he wants to recover health during a raid. When you leave the raid your HP will automatically refill.

## The Van
The van is the "base" where you live and store your items.
The van can be upgraded in different ways.
...
### Modules
1. Radar system: Beeps when a new wave is about to start
2. Nitro: Makes it so that you can extract from a raid faster
3. Turret

## Enemies
1. Basic opponent: generic AI robot, human-sized, the most common enemy, katana in hand, pretty easy to kill
2. Mini-boss: A harder-to-kill enemy than the basic ones; should spawn every fifth raid round.
3. Boss: The final boss in the game; should be very hard to defeat and should require substantial playtime and preparation to obtain the loot needed to beat it.
2. Mini-boss: A harder to kill enemy then the basic ones, should spawn every fith raid round.
